...
$initialAdmin = ['id' => 1, 'role' => 'admin'];
$owner = $service->create(CreateUserDTO::fromArray(['name' => 'Administrador', 'email' => 'admin-teste@example.com', 'password' => 'Senha@123', 'role' => 'admin']), $initialAdmin);
$admin = ['id' => $owner['id'], 'role' => 'admin'];
...
try { $service->update($admin['id'], UpdateUserDTO::fromArray(['name' => 'Administrador', 'email' => 'admin-teste@example.com', 'password' => '', 'role' => 'user']), $admin); throw new RuntimeException('Autoalteração de perfil permitida.'); } catch (\App\Support\ValidationException) {}
